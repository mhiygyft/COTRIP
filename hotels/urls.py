...
path(
    'api/hotel/<int:hotel_id>/availability/',
    views.HotelAvailabilityView.as_view(),
    name='hotel_availability'
),

path(
    'api/filters/',
    views.FilterOptionsView.as_view(),
    name='filter_options'
),

path(
    'api/itinerary-builder/',
    views.ItineraryBuilderAPIView.as_view(),
    name='itinerary_builder_api'
),

# THÊM ĐOẠN NÀY
path(
    'api/editable-itinerary/<int:itinerary_id>/',
    views.editable_itinerary_api,
    name='editable_itinerary_api'
),
]